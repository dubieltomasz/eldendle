...
Stylized with **Framer Motion** for smooth user experience.

## Credits
Game data used in this project was extracted from [Elden Ring](https://store.steampowered.com/app/1245620/ELDEN_RING/) using external programs: 
